...
class UpBlock(torch.nn.Module):
	...
	def __init__(self, in_channels, out_channels, kernel_size=(2,2,2),stride=(2,2,2)):
		...
		self.up_conv = torch.nn.ConvTranspose3d(in_channels,out_channels,kernel_size=kernel_size,stride=stride)
...
class MultiResUnet(torch.nn.Module):
	...
	'''
	def __init__(self, input_channels, output_channels, alpha=1.67):
		super().__init__()
		...
		# Decoder path
		self.upsample6 = UpBlock(self.in_filters5,32*8,kernel_size=(2,2,2),stride=(2,2,2))  
		...
		self.upsample7 = UpBlock(self.in_filters6,32*4,kernel_size=(2,2,2),stride=(2,2,2))  
		...
		self.upsample8 = UpBlock(self.in_filters7,32*2,kernel_size=(2,2,2),stride=(2,2,2))
		...
		self.upsample9 = UpBlock(self.in_filters8,32,kernel_size=(2,2,2),stride=(2,2,2))
		...
		self.conv_final = Conv3d_batchnorm(self.in_filters9, output_channels, kernel_size = (1,1,1), activation='None')
	...
	def forward(self,x : torch.Tensor)->torch.Tensor:
		...
		up6 = self.upsample6(x_multires5,x_multires4)
		x_multires6 = self.multiresblock6(up6)

		up7 = self.upsample7(x_multires6,x_multires3)
		x_multires7 = self.multiresblock7(up7)

		up8 = self.upsample8(x_multires7,x_multires2)
		x_multires8 = self.multiresblock8(up8)

		up9 = self.upsample9(x_multires8,x_multires1)
